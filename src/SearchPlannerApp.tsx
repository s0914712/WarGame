...
import { Languages, Map as MapIcon } from "lucide-react";
 ...
 */
function NoMapFallback({ lang }: { lang: "zh" | "en" }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        maxWidth: 440, padding: 20, borderRadius: 8,
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 12 }}>
          <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14, color: "#94a3b8" }}>
            <span style={{ width: 140 }}>{txt.cornerA}</span>
          ...
          <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14, color: "#94a3b8" }}>
            <span style={{ width: 140 }}>{txt.cornerB}</span>
